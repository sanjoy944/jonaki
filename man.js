 ...
 * TripleFlap, a flying twitter bird v1.2 for Blogger
 By https://www.mobileflasherbd.com
 */
...
var birdSprite = "https://2.bp.blogspot.com/-s_gZisAJOj8/UyBEjHKWtSI/AAAAAAAAOAg/NWqng21Bips/s1600/suyb-tb-sprite.png";
...
function tripleflapInit(reallystart) {
	...
	var tweetthislink = "https://www.youtube.com/home?status=" + escape(tweetThisText);
	if (twitterAccount == "") showTweet = false;
	var accountURL = (twitterAccount != "") ? "https://www.youtube.com/c/" + twitterAccount : ((otherPageOrFeed != false) ? otherPageOrFeed : "https://www.youtube.com/c/");
	...
	tBird.onmouseover = function () {
		scareTheBird();
		showButtonssTimeout = window.setTimeout("showButtonss(0," + windowWidth + "," + windowHeight + ")", 400);
...
function showButtonss(step, winWidth, winHeight) {
	birdPosY = parseInt(document.getElementById("tBird").style.top);
	birdPosX = parseInt(document.getElementById("tBird").style.left);
	...
	step++;
	showButtonssTimeout = window.setTimeout("showButtonss(" + step + "," + winWidth + "," + winHeight + ")", 60);
}

function hideButtons() {
	window.clearTimeout(showButtonssTimeout);
